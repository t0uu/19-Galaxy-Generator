...
/**
 * You can try to add more tweaks, test other galaxy other shapes, use a texture for the particles,rotate the galaxy, create multiple galaxies,etc.
...
const generateGalaxy = () => {
    ...
    // Before assigning those variables, we can test if they already exist and use the dispose() method to destroy the geometry and the material property 
...
for(let i = 0; i < parameters.count; i++){
    ...
    // Create random value for each axis and multiply it by the radius and randomness parameters then apply them to the position
    ...
    // Create a third Color by cloning the colorInside and use the lerp(...) method to mix it with the colorOutside
